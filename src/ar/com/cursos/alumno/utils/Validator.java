...
public class Validator {
    ...
    public boolean isInteger(){
        try {
            ...
            JOptionPane.showMessageDialog(null, "Se espera un número entero.");
            requestFocus();
            return false;
        }
    }
    ...
    public boolean isInteger(int min,int max){
        ...
        JOptionPane.showMessageDialog(null, "Se espera un número "
                + "entre "+min+" y "+max);
        requestFocus();
        return false;
    }
    ...
    public boolean isSize(int size){
        ...
        JOptionPane.showMessageDialog(null, "Se espera un largo de "
            +size+" letras");
        requestFocus();
        return false;
    }
    
    public boolean isSize(int min,int max){
        if(getText().length()>=min && getText().length()<=max) return true;
        JOptionPane.showMessageDialog(null, "Se espera un lardo de texto "
                + "entre "+min+" y "+max+" letras");
        requestFocus();
        return false;
    }
